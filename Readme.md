...
- The NLP part let you learn basic NLP techniques and work on using SVM on text.
- The Audio Classification part let you learn to implement the Audio Classification Model on Arduino Nano BLE and Extracting Data from Serial and storing them in a CSV file.
